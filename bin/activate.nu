...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/bartek/workspace/ONL_PYT_W_22_podstawy_django'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/bartek/workspace/ONL_PYT_W_22_podstawy_django/bin/deactivate.nu'
